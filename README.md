...
The **Airstream application bundle** workflow links the same small Scala.js application against Airstream at the parent commit and at the Vector specialization commit. This measures the marginal bundle change after Airstream's normal reachable-code linking, rather than comparing isolated method snippets.
